...
# Patel Music Bot <img src="https://img.shields.io/github/v/release/TeamYukki/YukkiMusicBot?color=black&logo=github&logoColor=black&style=social" alt="LICENSE">

[Patel Music Bot](https://github.com/Mastimusic/patelMusicBot) is a Powerful Telegram Music+Video Bot written in Python using Pyrogram and Py-Tgcalls by which you can stream songs, video and even live streams in your group calls via various sources.
...
- [GitHub Issues](https://github.com/Mastimusic/patelMusicBot/issues/new?assignees=&labels=question&template=SUPPORT_QUESTION.md&title=support%3A+)
...
- Add a [GitHub Star](https://github.com/Mastimusic/patelMusicBot) to the project.
- Fork the Repo :)
...
For a full list of all authors and contributors, see [the contributors page](https://github.com/Mastimusic/patelMusicBot/contributors).
